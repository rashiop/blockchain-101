...
/*
Normaly used for NFT
Mechanisms:
1. Seller of NFT deploys this contract setting a starting price for the NFT.
2. Auction lasts for 7days.
3. Price of NFT decreases over time.
4. Participants can buy by depositing
    ETH greater than the current price
...
contract DutchAuction {
    ...
    constructor(
        ...
        // immutable cant be access from ctor, so we use input

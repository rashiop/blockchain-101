...
1 token per contract to decrease security risk of one token compromised other token in
*/
...
contract CrowdFund {
    ...
    // Mapping from campaignId => pledgerId => amountPledge
